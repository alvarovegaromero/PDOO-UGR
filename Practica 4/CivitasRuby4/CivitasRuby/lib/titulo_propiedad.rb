...
module Civitas
  ...
  class TituloPropiedad
        ...
        attr_reader :alquiler_base, :factor_revalorizacion,  :hipoteca_base, 
                :hipotecado , :nombre, :num_casas, :num_hoteles, :precio_compra,
  ...
  def constructor_de_copia(titulo)
      @alquiler_base          = titulo.alquiler_base 
      @factor_revalorizacion  = titulo.factor_revalorizacion
      @hipoteca_base          = titulo.hipoteca_base
      @hipotecado             = titulo.hipotecado
      @nombre                 = titulo.nombre
      @num_casas              = titulo.num_casas
      @num_hoteles            = titulo.num_hoteles
      @precio_compra          = titulo.precio_compra
      @precio_edificar        = titulo.precio_edificar
      @propietario            = titulo.propietario
  end
