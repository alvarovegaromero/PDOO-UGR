...
public class CivitasJuego {
    ...
    */
    ...
    private void inicializarMazoSorpresas(Tablero tablero){
        ...
        this.mazo.alMazo( new SorpresaEspeculador(300, "Te conviertes en especulador!" ) );
        ...
        this.mazo.alMazo( new SorpresaIrCasilla(tablero, 17, "Viaja hasta la casilla 17!") );

        // Construimos otros tipos de sorpresas (todos menos iracasilla, evitarcarcel e ircarcel)
        this.mazo.alMazo( new SorpresaPagarCobrar( 150, "A cobrar 150!") );
        this.mazo.alMazo( new SorpresaPagarCobrar(-150, "A pagar 150!" ) );
        
        this.mazo.alMazo( new SorpresaPorCasaHotel( 50, "A pagar 50 por cada casa u hotel ):") );
        this.mazo.alMazo( new SorpresaPorJugador( 100, "A pagar 100 a cada jugador!") );
    ...
    private void inicializarTablero(MazoSorpresas mazo){
        ...
        // La casilla 0 es la Salida
        
                this.tablero.añadeCasilla(new CasillaSorpresa(mazo,"SORPRESA ALEATORIA") ); 

        
        // Aniadimos casilla de CALLE 1
        this.tablero.añadeCasilla(new CasillaCalle(new TituloPropiedad ("Calle Chispas", 50, (float) 1.1, 50, 100, 60)));
        
        // Aniadimos casillas SORPRESA 2, 3
        this.tablero.añadeCasilla(new CasillaSorpresa(mazo,"SORPRESA ALEATORIA") ); 
        this.tablero.añadeCasilla(new CasillaSorpresa(mazo,"SORPRESA ALEATORIA") ); 
        
        // Aniadimos casilla del JUEZ 4
        this.tablero.añadeJuez();
        
        // Aniadimos casillas de CALLE 5, 6
        this.tablero.añadeCasilla(new CasillaCalle(new TituloPropiedad ("Calle Dendi",   50, (float) 1.1, 50, 100, 60)));
        this.tablero.añadeCasilla(new CasillaCalle(new TituloPropiedad ("Calle Ambi",    60, (float) 1.1, 60, 120, 70)));        
        
        // Aniadimos casilla SORPRESA 7
        this.tablero.añadeCasilla(new CasillaSorpresa(mazo,"SORPRESA ALEATORIA") );
        
        // Aniadimos casilla IMPUESTO 8
       this.tablero.añadeCasilla(new CasillaImpuesto( precioImpuesto, "Impuesto Circulacion") );
    
        // Aniadimos casilla de CALLE 9
        this.tablero.añadeCasilla( new CasillaCalle( new TituloPropiedad ("Calle Liada",   60, (float) 1.1, 60, 120, 70 ) ) );
        
        // La carcel esta en la 9
        
        // Aniadimos casilla de CALLE 11, 12, 13
        this.tablero.añadeCasilla( new CasillaCalle( new TituloPropiedad ("Calle Alexa",   60, (float) 1.1, 60, 120, 70 ) ) );
        this.tablero.añadeCasilla( new CasillaCalle( new TituloPropiedad ("Calle Tiempo",  70, (float) 1.1, 70, 140, 90 ) ) );
        this.tablero.añadeCasilla( new CasillaCalle( new TituloPropiedad ("Calle Seya",    70, (float) 1.1, 70, 140, 90 ) ) ); 
        
        // Aniadimos casilla SORPRESA 14
        this.tablero.añadeCasilla(new CasillaSorpresa(mazo,"SORPRESA ALEATORIA") );
        
        // Aniadimos casilla IMPUESTO 15
        this.tablero.añadeCasilla(new CasillaImpuesto( precioImpuesto * 2, "Impuesto Medioambiental") );
        
        // Aniadimos casillas de CALLE 16, 17
        this.tablero.añadeCasilla( new CasillaCalle( new TituloPropiedad ("Calle Yeyiii",  70, (float) 1.1, 70, 140, 90 ) ) );
        this.tablero.añadeCasilla( new CasillaCalle( new TituloPropiedad ("Calle Brasa",   90, (float) 1.1, 90, 160, 120) ) );
               
        // Aniadimos casilla de DESCANSO 18
        this.tablero.añadeCasilla( new Casilla("PARKING") );
        
        // Aniadimos casillas SORPRESA 19
        this.tablero.añadeCasilla(new CasillaSorpresa(mazo,"SORPRESA ALEATORIA") );
        
        // Aniadimos casillas de CALLE 20
        this.tablero.añadeCasilla( new CasillaCalle( new TituloPropiedad ("Calle Lastima", 90, (float) 1.1, 90, 160, 120) ) );
